...
class MyRobot(wpilib.SampleRobot):
    ...
    def operatorControl(self):
        ...
        while self.isOperatorControl() and self.isEnabled():
                ...
                if self.controller.getLeftTrigger()==True:
                    ...
                    if(self.controller.getButtonB()):
                        ...
                        if self.controller.getRightBumper():
                            ...
                            #self.drive.autonTankDrive(self.controller.getRightY()*.55, self.controller.getLeftY()*.55)
            ...
            self.opControl.operatorFunctions(self.controller2.getButtonA(), self.controller2.getButtonB(), self.controller2.getButtonX(), self.controller2.getButtonY(), self.controller2.getLeftY(), self.controller2.getRightTrigger(), self.controller2.getLeftTrigger(), self.controller2.getLeftBumper())
